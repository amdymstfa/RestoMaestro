...
<head>
    ...
    <title>Modifier Réservation - RestauManager</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="flex-1">
            <!-- Top Navigation -->
            @include('manager.partials.header', ['title' => 'Modifier Réservation'])

            <!-- Content -->
            <main class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="mb-6">
                    <a href="{{ route('manager.reservations.show', $reservation) }}" class="text-primary hover:text-amber-600">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="client_name" id="client_name" required
                                            value="{{ old('client_name', $reservation->client_name) }}"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="datetime-local" name="reservation_time" id="reservation_time" required
                                            value="{{ old('reservation_time', $reservation->reservation_time->format('Y-m-d\TH:i')) }}"
