...
<head>
    ...
    <title>Modifier Table - RestauManager</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="flex-1">
            <!-- Top Navigation -->
            @include('manager.partials.header', ['title' => 'Modifier Table'])

            <!-- Content -->
            <main class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="mb-6">
                    <a href="{{ route('manager.tables.show', $table) }}" class="text-primary hover:text-amber-600">
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <form method="POST" action="{{ route('manager.tables.update', $table) }}">
                            @csrf
                            @method('PUT')
